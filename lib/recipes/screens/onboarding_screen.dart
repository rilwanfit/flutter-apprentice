...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget buildPages() {
    return PageView(
      ...
      children: [
        onboardPageView(
          const AssetImage('assets/recipes/fooderlich_assets/recommend.png'),
          '''Check out weekly recommended recipes and what your friends are cooking!''',
        ),
        onboardPageView(
          const AssetImage('assets/recipes/fooderlich_assets/sheet.png'),
          'Cook with step by step instructions!',
        ),
        onboardPageView(
          const AssetImage('assets/recipes/fooderlich_assets/list.png'),
